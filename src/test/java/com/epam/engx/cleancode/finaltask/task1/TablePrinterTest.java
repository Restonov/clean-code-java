...
public class TablePrinterTest {
    ...
    public void setup() {
        ...
        TableService tableService = new TableService(manager);
        command = new TablePrinter(view, tableService);
    }
    ...
    public void shouldPrintMessageForNotExistingTable() {
        //given
        Mockito.when(manager.getTableData("testing")).thenReturn(new LinkedList<>());
        //when
